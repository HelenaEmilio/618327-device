...
* Студент: [Елена Омельченко](https://up.htmlacademy.ru/htmlcss/20/user/618327).
<<<<<<< HEAD
* Наставник: `Евгений Котов`..
=======
* Наставник: `Неизвестно`.
>>>>>>> parent of d2ddf47... Добавила имя наставника
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/618327-device) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
